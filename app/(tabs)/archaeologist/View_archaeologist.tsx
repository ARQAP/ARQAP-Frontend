...
export default function View_archaeologist() {
    ...
    const archaeologistItems = useMemo<
        SimplePickerItem<Archaeologist>[]
    >(() => {
        return (data || []).map((a) => ({
    ...
    const searchDisplayText = useMemo(() => {
        if (selectedArchaeologistId) {
            return archaeologistItems.find(
                (i) => i.value === selectedArchaeologistId
            )?.label;
        }
        if (searchText) {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            Administra y consulta el registro de arqueólogos del
                            sistema
                        </Text>
