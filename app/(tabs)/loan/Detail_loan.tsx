  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#F3E9DD" }}>
      ...
      <ScrollView style={{ flex: 1, padding: 20 }}>
        ...
        <View
          style={{
            backgroundColor: isFinished ? Colors.green : Colors.brown,
            padding: 15,
            borderRadius: 12,
            marginBottom: 20,
            flexDirection: "row",
        ...
        >
          ...
          >
            {isFinished ? "Préstamo Finalizado" : "Préstamo en Curso"}
          </Text>
        </View>
        ...
        >
          ...
          <View style={{ gap: 12 }}>
            <View>
              <Text
                style={{ fontWeight: "600", color: "#555", marginBottom: 4 }}
              >
        ...
        {!isFinished && (
          <TouchableOpacity
            onPress={() =>
              loan.id && router.push(`/(tabs)/loan/Finish_loan?id=${loan.id}`)
            }
            style={{
