...
export default function NewLoan() {
    ...
    // Hooks para datos
    const { data: artefacts = [], isLoading: loadingArtefacts } =
        useArtefacts();
                                ...
                                >
                                    <Text
                                        style={{
                                            fontFamily: "CrimsonText-Regular",
                                            fontSize: 16,
                                            color: selectedArtefactName
                                                ? "#4A3725"
                                                : "#B8967D",
                                            flex: 1,
                                        }}
                                    >
                                        {selectedArtefactName ||
